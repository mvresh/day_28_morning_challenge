...
List holisticFlattenList(dynamic givenList){
  List finalList = [];
...
main() {
  print(holisticFlattenList([1, "2",() { return 4; }, [3, 'hello', [ "five" ], "six", true, { 'prop': "val" }]]));
  print(holisticFlattenList([1, "2",() { return 'how are you'; }, [3, 'hello', [ "five" ], "six", true, { 'prop': "val" }]]));
  print(holisticFlattenList([1, "2",() { return (4+8); }, [3, 'hello', [ "five" ], "six", true, { 'prop': "val" }]]));
  print(holisticFlattenList([1, "2",() { return [1,3,5,7,9]; }, [3, 'hello', [ "five" ], "six", true, { 'prop': "val" }]]));
}
